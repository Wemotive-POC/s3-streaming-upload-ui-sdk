...
// 100GB.
// ===============================================
  myUploadProgress = (params) => (progressEvent) => {
      console.log("myUploadProgress params=====>", params);
      console.log("myUploadProgress progressEvent=====>", progressEvent);
  }
  async uploadMultipartFile() {
    try {
      ...
      console.log('resolvedAr=====>', resolvedArray)

      let uploadPartsArray = []
      resolvedArray.forEach((resolvedPromise, index) => {
        console.log("resolvedPromise.headers.etag====>", resolvedPromise.headers);
      ...
      console.log('Stuff=====>', completeUploadResp.data)
